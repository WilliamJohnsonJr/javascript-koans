...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      products.filter(function(object){
         if (object.containsNuts === false && _(object.ingredients).any(hasMush)===false){
          productsICanEat.push(object);
         }
      });
      expect(productsICanEat.length).toBe(1);
  });
  ...
  /*********************************************************************************/
   it("should count the ingredient occurrence (imperative)", function () {
    ...
    for (i = 0; i < products.length; i+=1) { // loop over the products
        for (j = 0; j < products[i].ingredients.length; j+=1) { // loop over the ingredients in each product
